...
/* Tutorials zone refreshed color theme */
.tutorials-zone {
  border: 1px solid rgba(170, 126, 255, 0.42);
  border-radius: 28px;
  padding: 22px;
  background:
    radial-gradient(circle at top right, rgba(199, 134, 255, 0.24), transparent 45%),
    linear-gradient(180deg, rgba(32, 17, 58, 0.86), rgba(15, 10, 34, 0.97));
}
...
.tutorials-zone h2 {
  color: #f6ecff;
  text-shadow: 0 0 24px rgba(194, 134, 255, 0.4);
}

.tutorials-zone .feature-card {
  border-color: rgba(188, 139, 255, 0.3);
  background: linear-gradient(180deg, rgba(55, 34, 92, 0.72), rgba(27, 18, 52, 0.9));
}
...
.tutorials-zone .feature-card:hover {
  border-color: rgba(208, 163, 255, 0.58);
